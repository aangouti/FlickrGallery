...
class PhotoCollectionViewController: UICollectionViewController {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView!.register(UICollectionViewCell.self, forCellWithReuseIdentifier: loadCellReuseIdentifier)
    ...
    func fetchPhotos() {
        ApiClient.shared.getPhotos(page: lastPage) { [unowned self] (result) in
            self.lastPage += 1
            switch result {
...
extension PhotoCollectionViewController {
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let imageUrl = fetchedPhotos[indexPath.row].imageUrl(size: Constants.SizeSuffix.t.rawValue) {
    ...
    func handleNewPhotos(photosObject: Photos) {
        totalResult = photosObject.total
