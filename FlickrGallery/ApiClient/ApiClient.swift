...
class ApiClient {
    ...
    func getPhotos(page: Int, completion: @escaping (_ result: ResultType) -> Void)  {
        let querystringParameters: [String: AnyObject] = ["method": Constants.Methods.getRecentPhotos as AnyObject,
        ...
        let task = session.dataTask(with: request) { (data, response, error) in
            ...
            do {
                let apiResult = try JSONDecoder().decode(ApiResponse.self, from: data)
